...
var ClassComment = require('../../model/ClassComment');
...
router.get('/:pid',function (req,res) {
    if (req.params.pid) {
        ClassComment.getCommentsByPId(req.params.pid,function (results) {
            async.mapLimit(results,1,function (item,callback) {
                ClassComment.getCommentsByPId(item._id,function (commentResults) {
...
router.post('/', function(req, res) {
    ...
    if (requestJson["_id"] != null && requestJson["_id"] != "" && requestJson["_id"] != undefined){
        ClassComment.getCommentsById(requestJson["_id"],function (result) {
            ...
            Class.getClassByID(requestJson["parentId"],function (t) {
                if (t != null){
                    if(t.comment){
...
router.post('/support',function (req,res) {
    ...
    if (requestJson["id"] != null && requestJson["id"] != "" && requestJson["id"] != undefined){
        ClassComment.getCommentsById(requestJson["id"],function (result) {
            if (result.support){
